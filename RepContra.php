...
<html lang="es">
    <head>
        ...
        <title>OMEGA TECH S.A. - Recuperar Contraseña</title>
    ...
    <body>
        ...
        <div class="breadcrumb-simple">
            <a href="Inicio.php">Inicio</a> / Recuperar Contraseña
        </div>
        ...
        <div class="recovery-section">
            <div class="recovery-container">
                <div class="recovery-box">
                    ...
                    <p>Introduzca la dirección de correo electrónico asociada a su cuenta.</p>
