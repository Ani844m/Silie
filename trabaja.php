...
<head>
    ...
    <title>Omega Tech - Trabaja con nosotros</title>
...
<body>
    ...
    <nav class="main-nav">
        ...
        <a href="Inicio.php">Inicio</a> / <span class="current-page">Trabaja con nosotros</span>
    </div>
    <!-- CSS -->
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.dropdown-mega').mouseleave(function () {
                var menu = $(this).find("ul");
                menu.css({ top: "", bottom: "" }).removeClass("dropdown-mega-visible");
            });

            $('#select-currency').change(function () {
                $.post("/Home/ChangeCurrency", { currencyId: $(this).val() }, function () {
...
<body>
    ...
    <div class="body-content">
        <div class="container">
            <iframe src="https://autoservicio.omega.com.do/spnweb/wforms/wfSolicitudEmpleo.aspx" 
                title="Work with us" frameborder="0" 
                style="height:75vh;width:100%; margin-top:5px; border:2px solid #000000">
            </iframe>
        </div>
    </div>
