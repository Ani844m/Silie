...
<head>
    ...
    <title>Omega Tech - Ofertas y promociones</title>
...
<body>
            ...
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu account-menu">
                        <li><a href="#" class="account-button">Identificarse</a></li>
                        <li><a href="#" class="account-button register-button">Regístrate</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <h2 style="color: rgb(165, 6, 6);"> Gracias! Recibirá nuestras ofertas y promociones directamente <br>en su buzón de correo electrónico.  <br> <br> <br> <br> </h2>
