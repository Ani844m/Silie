...
<head>
    ...
    <title>OMEGA TECH S.A. - Conócenos</title>
...
<body>
    ...
    <div class="breadcrumb">
        <a href="Inicio.php">Inicio</a> / <span class="current-page">Conócenos</span>
    </div>

    <!-- Remove this duplicate body tag -->
    <!-- <body> -->
    
    <header class="hero">
        <div class="hero-content">
            <h1 class="hero-title">Somos los líderes en tecnología</h1>
            <p class="hero-subtitle">en el país</p>
        </div>
    </header>
    ...
    <section class="vision">
        <div class="container">
            <div class="vision-text">
                ...
                <p>Fortalecer mediante la innovación y aprendizaje continuo nuestro liderazgo en el <br> mercado, elevando el nivel de nuestro capital humano para consolidarnos como <br>suplidor por excelencia en soluciones tecnológicas.</p>
            </div>
            <div class="vision-icon">
                <img src="https://cdn-icons-png.freepik.com/512/18/18484.png" alt="Icono de objetivo"> 
            </div>
        </div>
    </section>
    ...
    <section class="stats">
        <div class="container">
            <div class="stat">
                <h2 id="sucursales">0</h2>
                <p>Sucursales</p>
            </div>
            <div class="stat">
                <h2 id="anios">0</h2>
                <p>Años a su servicio</p>
            </div>
        </div>
    </section>
    ...
    <section class="mission">
        <div class="container">
            <div class="mission-icon">
                <img src="https://cdn-icons-png.freepik.com/512/407/407118.png" alt="Icono de cohete">
            </div>
            <div class="mission-text">
                <h2>NUESTRA MISIÓN</h2>
                <p>Ofrecemos soluciones tecnológicas para satisfacer las necesidades del mercado a <br>nivel nacional, a través de la venta de bienes y servicios a precios competitivos, <br>apoyado en un personal calificado.</p>
            </div>
        </div>
    </section>
    ...
    const aniosElement = document.getElementById('anios');
    const sucursalesFinal = 10; // Número final para sucursales
    const aniosFinal = 14;      // Número final para años
    const duracion = 1800;      // Duración de la animación en milisegundos
    const intervalo = duracion / Math.max(sucursalesFinal, aniosFinal); // Intervalo para cada incremento

    let sucursalesActual = 0;
    let aniosActual = 0;
    let plusAdded = false; // Variable para controlar si se agregó el "+"

    // Mostrar el 0 inicialmente
    sucursalesElement.textContent = '0';
    aniosElement.textContent = '0';

    const contador = setInterval(function() {
        if (sucursalesActual < sucursalesFinal) {
            sucursalesActual++;
            sucursalesElement.textContent = sucursalesActual; // No agregar "+" hasta llegar a 10
        }

        if (aniosActual < aniosFinal) {
            aniosActual++;
            aniosElement.textContent = aniosActual;
        }

        if (sucursalesActual === sucursalesFinal && !plusAdded) {
            sucursalesElement.textContent += '+'; // Agregar "+" cuando llega a 10
            plusAdded = true; // Marcar que se agregó el "+"
        }

        if (sucursalesActual >= sucursalesFinal && aniosActual >= aniosFinal) {
    ...
    <footer class="footer">
        ...
        <div class="footer-middle">
            ...
            <div class="footer-column">
                ...
                <a href="sucursales.php">Nuestras Sucursales</a>
            </div>
            <div class="footer-column">
                <h3>CARRERA</h3>
